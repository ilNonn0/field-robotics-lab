# Field Robotics and Perception Lab

**Istituto di Intelligenza Meccanica — Scuola Superiore Sant'Anna, Pisa**

This repository hosts the website of the **Field Robotics and Perception Lab**, a research laboratory focused on autonomous aerial and terrestrial robotics for inspection, exploration, and environmental monitoring.

🌐 **Live site:** [ilNonn0.github.io/field-robotics-lab](https://ilNonn0.github.io/field-robotics-lab)
...
- VICON Vero motion capture arena (10 cameras, 4×6×3 m, 1 mm accuracy, 333 Hz)
- Custom 7" autonomous quadrotors with x86 companion computers
- Drone X500 with LiDAR Ouster OS0-32, FLIR Boson 640, OAK-D stereo, Intel NUC
- Edge inference UAV with NVIDIA Jetson Orin NX
- Clearpath Husky A200 UGV + Unitree Go2 EDU Plus quadruped
- Kinova Gen3 7DoF arm for mobile manipulation
...
[Google Scholar](https://scholar.google.com/citations?user=BJVasGYAAAAJ) · [TERRA Lab — BRIEF](https://biorob-hub.eu/infrastructures/wp6/terra-terrestrial-and-aerial-robotics-for-large-infrastructures-and-environment-monitoring/)

---

*Scuola Superiore Sant'Anna · Pisa, Italy · 2026*
